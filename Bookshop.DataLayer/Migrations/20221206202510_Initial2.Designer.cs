...
namespace Bookshop.DataLayer.Migrations
{
    ...
    [Migration("20221206202510_Initial2")]
            ...
            modelBuilder.Entity("Bookshop.DataLayer.Models.ApplicationRole", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        ...
                        .HasDefaultValue(new DateTime(2022, 12, 6, 20, 25, 10, 435, DateTimeKind.Utc).AddTicks(7815));
            ...
            modelBuilder.Entity("Bookshop.DataLayer.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 6, 20, 25, 10, 435, DateTimeKind.Utc).AddTicks(7933));
                    ...
                    b.Property<DateTime>("LastLogin")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 6, 20, 25, 10, 435, DateTimeKind.Utc).AddTicks(9757));
            ...
            modelBuilder.Entity("Bookshop.DataLayer.Models.Book", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 6, 20, 25, 10, 435, DateTimeKind.Utc).AddTicks(8003));
            ...
            modelBuilder.Entity("Bookshop.DataLayer.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 6, 20, 25, 10, 435, DateTimeKind.Utc).AddTicks(8181));
            ...
            modelBuilder.Entity("Bookshop.DataLayer.Models.OrderState", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 6, 20, 25, 10, 435, DateTimeKind.Utc).AddTicks(8283));
            ...
            modelBuilder.Entity("Bookshop.DataLayer.Models.Rating", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 6, 20, 25, 10, 435, DateTimeKind.Utc).AddTicks(8374));
