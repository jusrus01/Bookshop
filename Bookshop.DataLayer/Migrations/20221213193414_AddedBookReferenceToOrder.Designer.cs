...
namespace Bookshop.DataLayer.Migrations
{
    ...
    [Migration("20221213193414_AddedBookReferenceToOrder")]
    partial class AddedBookReferenceToOrder
    {
            ...
            modelBuilder.Entity("Bookshop.DataLayer.Models.ApplicationRole", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        ...
                        .HasDefaultValue(new DateTime(2022, 12, 13, 19, 34, 14, 224, DateTimeKind.Utc).AddTicks(1211));
            ...
            modelBuilder.Entity("Bookshop.DataLayer.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 13, 19, 34, 14, 224, DateTimeKind.Utc).AddTicks(1349));
                    ...
                    b.Property<DateTime>("LastLogin")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 13, 19, 34, 14, 224, DateTimeKind.Utc).AddTicks(3688));
            ...
            modelBuilder.Entity("Bookshop.DataLayer.Models.Book", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 13, 19, 34, 14, 224, DateTimeKind.Utc).AddTicks(1440));
            ...
            modelBuilder.Entity("Bookshop.DataLayer.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 13, 19, 34, 14, 224, DateTimeKind.Utc).AddTicks(1631));
            ...
            modelBuilder.Entity("Bookshop.DataLayer.Models.OrderState", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 13, 19, 34, 14, 224, DateTimeKind.Utc).AddTicks(1793));
            ...
            modelBuilder.Entity("Bookshop.DataLayer.Models.Rating", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 13, 19, 34, 14, 224, DateTimeKind.Utc).AddTicks(1908));
            ...
            modelBuilder.Entity("Bookshop.DataLayer.Models.Book", b =>
                {
                    ...
                    b.HasOne("Bookshop.DataLayer.Models.Order", "Order")
                        .WithMany("Books")
